...
{
    public function testImportPocketHtml(): void
    {
        $this->logInAs('admin');
    ...
    public function testImportPocketHtmlWithRabbitEnabled(): void
    {
        $this->logInAs('admin');
        $client = $this->getTestClient();
    ...
    public function testImportPocketHtmlBadFile(): void
    {
        $this->logInAs('admin');
        $client = $this->getTestClient();
    ...
    public function testImportPocketHtmlWithRedisEnabled(): void
    {
        $this->checkRedis();
        $this->logInAs('admin');
        $client = $this->getTestClient();
    ...
    public function testImportPocketHtmlWithFile(): void
    {
        $this->logInAs('admin');
        $client = $this->getTestClient();
    ...
    public function testImportPocketHtmlWithEmptyFile(): void
    {
        $this->logInAs('admin');
        $client = $this->getTestClient();
    ...
    public function testImportPocketHtmlDisabled(): void
    {
        $this->logInAs('admin');
        $client = $this->getTestClient();
