...
{
    public function testImportFirefox(): void
    {
        $this->logInAs('admin');
    ...
    public function testImportFirefoxWithRabbitEnabled(): void
    {
        $this->logInAs('admin');
        $client = $this->getTestClient();
    ...
    public function testImportFirefoxBadFile(): void
    {
        $this->logInAs('admin');
        $client = $this->getTestClient();
    ...
    public function testImportFirefoxWithRedisEnabled(): void
    {
        $this->checkRedis();
        $this->logInAs('admin');
        $client = $this->getTestClient();
    ...
    public function testImportFirefoxWithFile(): void
    {
        $this->logInAs('admin');
        $client = $this->getTestClient();
    ...
    public function testImportFirefoxWithEmptyFile(): void
    {
        $this->logInAs('admin');
        $client = $this->getTestClient();
    ...
    public function testImportFirefoxDisabled(): void
    {
        $this->logInAs('admin');
        $client = $this->getTestClient();
