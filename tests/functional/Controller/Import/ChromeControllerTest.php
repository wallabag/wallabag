...
{
    public function testImportChrome(): void
    {
        $this->logInAs('admin');
    ...
    public function testImportChromeWithRabbitEnabled(): void
    {
        $this->logInAs('admin');
        $client = $this->getTestClient();
    ...
    public function testImportChromeBadFile(): void
    {
        $this->logInAs('admin');
        $client = $this->getTestClient();
    ...
    public function testImportChromeWithRedisEnabled(): void
    {
        $this->checkRedis();
        $this->logInAs('admin');
        $client = $this->getTestClient();
    ...
    public function testImportChromeWithFile(): void
    {
        $this->logInAs('admin');
        $client = $this->getTestClient();
    ...
    public function testImportChromeWithEmptyFile(): void
    {
        $this->logInAs('admin');
        $client = $this->getTestClient();
    ...
    public function testImportChromeDisabled(): void
    {
        $this->logInAs('admin');
        $client = $this->getTestClient();
