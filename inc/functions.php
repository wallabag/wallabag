 ...
 *
 * @category   poche
 * @author     Nicolas L≈ìuillet <support@inthepoche.com>
 * @copyright  2013
 * @license    http://www.wtfpl.net/ see COPYING file
 */

/**
 * Permet de g√©n√©rer l'URL de poche pour le bookmarklet
 */
...
function remove_relative_links($data, $base) {
	...
	// ne conserve que les liens ne commenÁant pas par un protocole ´ protocole:// ª ni par une ancre ´ # ª
...
/**
 * Pr√©paration de l'URL avec r√©cup√©ration du contenu avant insertion en base
 */
