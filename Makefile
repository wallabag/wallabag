...
.PHONY: help install update build test test-unit test-integration test-functional release deploy run dev dev-docker-up dev-docker-down fix-cs phpstan phpstan-baseline lint-js lint-scss
